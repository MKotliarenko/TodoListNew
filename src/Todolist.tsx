...
type PropsType = {
    ...
    editTitleTasks:(todolistId:string, taskId:string, title:string)=>void
}
...
export function Todolist(props: PropsType) {
    ...
    const editTitleTaskHandler=(taskId:string, title:string)=>{
        props.editTitleTasks(props.id, taskId, title)
    }
        ...
        <ul>
            {
                props.tasks.map(t => {
                    ...
                    return <li key={t.id} className={t.isDone ? "is-done" : ""}>
                        ...
                        {/*<span>{t.title}</span>*/}
                        <span><EditableSpan callBack={(titleNew)=>{editTitleTaskHandler(t.id,titleNew)}} title={t.title}/></span>
